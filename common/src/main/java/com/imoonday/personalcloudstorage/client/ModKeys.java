...
public class ModKeys {
    ...
    public static final KeyBinding OPEN_CLOUD_STORAGE_INVENTORY = new KeyBinding("key.personalcloudstorage.inventory", GLFW.GLFW_KEY_O, CATEGORY, mc -> ClientHandler.openCloudStorage());
